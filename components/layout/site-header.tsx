  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur-md bg-[color:var(--color-background)]/90 border-b border-[color:var(--color-hairline)]">
      ...
      <div className="container-wide flex items-center gap-3 lg:gap-4 h-16">
        ...
        {/* Bilgi için — masaüstünde iletişim sayfasına gider (tel: masaüstü
            Chrome'da tepkisiz kaldığından). Mobil arama, menü içindeki ayrı
            PhoneCTA ile korunur. */}
        <Link
          href="/contact"
          aria-label="İletişim ve telefon bilgileri"
          className="hidden xl:inline-flex shrink-0 items-center h-9 px-3 text-[10px] tracking-[0.22em] uppercase border whitespace-nowrap hover:text-[color:var(--color-walnut-dark)] transition-colors"
